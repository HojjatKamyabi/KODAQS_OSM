...
Load and prepare official built environment data from the POI-Bund dataset as a benchmark for comparison.\
...
```{r, warning=FALSE}
german_municipalities <- st_read("./data/municipalites_2021_epsg4326.shp")
